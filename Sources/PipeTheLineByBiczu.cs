...
public class PipeTheLineByBiczu : MonoBehaviour
{
   ...
   public void DrawPipe(Vector3[] _points)
    ...
    private class DrawState
    {
        ...
        private PipeTheLineByBiczu _parent;
        ...
        public DrawState(PipeTheLineByBiczu parent)
        {
            _parent = parent;
        }
